      ...
      <div class="modal-body">
		<form id="reg-form" class="needs-validation">
			<div class="form-group">
				...
				<input type="text" class="d-none id" name="map-id" id="map-id" value="">
			</div>
		</form>
      </div>
      <!--Footer-->
      ...
      <div class="modal-body">
		<form id="reg-form" class="needs-validation">
			<div class="form-group">
				...
				<input type="text" class="d-none id" name="gamer-id" id="gamer-id"  value="">
			</div>
		</form>
      </div>
      <!--Footer-->
      ...
      <div class="modal-body">
		<form class="needs-validation" id="reg-form">
			<div class="form-group">
				...
				<input type="text" class="d-none id" name="city-id" id="city-id" value="">
			</div>
		</form>
      </div>
      <!--Footer-->
